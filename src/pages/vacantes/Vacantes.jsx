      ...
      <div className="vacantes-container">
        <div className="vacantes-header">
          <div className="header-content">
            <h1 className="page-title">Gestión de Vacantes</h1>
            <p className="page-subtitle">
              Lista completa de vacantes publicadas
            </p>
          </div>
        ...
        <div className="table-container">
          <table className="vacantes-table">
            ...
            <tbody>
              <tr>
                <td>
                  <span className="vacante-id">VAC3452</span>
                </td>
                <td>
                  <span className="puesto-nombre">Desarrollador Frontend</span>
                </td>
                <td>
                ...
                <td>
                  <span className="salario-badge">
                    8000000
                  </span>
                </td>
                <td>
                  <span className="requisitos-text">React, JavaScript, CSS</span>
                </td>
                <td>
                ...
                <td>
                  <div className="acciones">
                    <button className="btn-accion btn-ver" title="Ver detalles">
                      <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
